...
import com.api.planiop.service.IInscriptosCebService;
...
public class InscriptosCebController {
    
    @Autowired
    private IInscriptosCebService intercebInscriptos;
    
    @GetMapping("/inscriptos_ceb/ver")
    @ResponseBody
    public List <InscriptosCeb> getInscriptosCeb(){
        return intercebInscriptos.getInscriptosCeb();
    }    
}
